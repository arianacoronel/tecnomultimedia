...
//video explicativo https://youtu.be/2haxqHCXTYY
...
void mousePressed(){
 ...
 if (estado == 0 && dentrodelboton(250, 510)) {
    ...
    estado = 2;
  } else if (estado == 2 && dentrodelboton2(200, 510)) {
    estado = 3;
  } else if (estado == 2 && dentrodelboton(400, 510)) {
    estado = 4;
  } else if (estado == 3 && dentrodelboton(250, 510)) {
    estado = 5;
  } else if (estado == 5 && dentrodelboton2(200, 510)) {
    estado = 6;
    ...
    estado = 10;
  } else if (estado == 10 && dentrodelboton2(200, 510)) {
    estado = 11;
